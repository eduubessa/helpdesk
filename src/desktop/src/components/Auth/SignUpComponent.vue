            ...
            <div class="form-container">
              ...
              <div class="row">
                <div class="container">
                  <div class="input-group">
                    <input class="form-control" v-model="firstname" type="text" placeholder="Nome" name="name" id="input-username" form="auth-sign">
                  </div>
                  <div class="input-group">
                    <input class="form-control" v-model="lastname" type="text" placeholder="Apelido" name="name" id="input-username" form="auth-sign">
                  </div>
                  <div class="input-group">
                  ...
                  <div class="container-fluid">
                    <button @click="authentication" class="btn btn-default pull-right">Criar conta</button>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-10 offset-1 text-center mt-5">
                  Já tenho  uma <a class="ml-1" href="/auth/login">conta</a>
